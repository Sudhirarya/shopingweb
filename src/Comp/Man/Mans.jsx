        ...
        <main>
            ...
            <div className='m-4'>
                ...
                <div className='d-flex justify-content-evenly flex-wrap my-2'>
                    <Link to='/manH'><img className='my-2 card' src={img4} alt="" style={{ width: '200px' }} /></Link>
                    <Link to='/manH'><img className='my-2 card' src={img5} alt="" style={{ width: '200px' }} /></Link>
                    <Link to='/manH'><img className='my-2 card' src={img6} alt="" style={{ width: '200px' }} /></Link>
                    <Link to='/manH'><img className='my-2 card' src={img7} alt="" style={{ width: '200px' }} /></Link>
                    <Link to='/manH'><img className='my-2 card' src={img8} alt="" style={{ width: '200px' }} /></Link>
                    <Link to='/manH'><img className='my-2 card' src={img9} alt="" style={{ width: '200px' }} /></Link>
                </div>
            </div>
            <div className='m-4'>
                <h2 className='m-3'>TRENDING IN INDIAN WEAR</h2>
                <div className='d-flex justify-content-evenly flex-wrap my-2'>
                    <Link to='/manH'><div className="card" style={{ width: "12rem" }}>
