const Homed = [
    ...
    {
      "id": 10,
      "title": "SanDisk SSD PLUS 1TB SSD - SATA III 6 Gb/s",
      "price": 109,
    ...
    {
      "id": 15,
      "title": "BIYLACLESEN 3-in-1 Snowboard Jacket Winter Coats",
      "price": 56.99,
    ...
    {
      "id": 16,
      "title": "emovable Hooded Faux Leather Moto Biker Jacket",
      "price": 29.95,
  ...
  export {Homed}
  export function getHomed(id){
    return Homed.find(Homed =>Homed.id === id)
 }
